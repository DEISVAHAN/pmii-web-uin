<?php
// public/dashboard/admin-dashboard-komisariat.php
...
<head>
    ...
    <title>Dashboard Admin Komisariat - PK PMII UIN Sunan Gunung Djati Cabang Kota Bandung</title>
    ...
    <link rel="stylesheet" href="../css/style.css"> <link rel="stylesheet" href="../css/admin-dashboard-komisariat.css"> </head>
<body>
        ...
        <main class="container mx-auto px-4 py-8 lg:py-12">
            <section id="admin-dashboard-content" class="py-6">
                <div class="text-center mb-10 md:mb-14">
                    <h1 class="text-3xl lg:text-4xl page-title">Dashboard Admin Komisariat</h1>
                    <p class="text-md text-text-muted mt-2">Selamat datang, <strong id="admin-name-dashboard" class="text-pmii-yellow font-semibold">[Nama Admin Komisariat]</strong>! Kelola sistem internal di sini.</p>
                </div>
                <div class="welcome-banner max-w-4xl mx-auto mb-10 md:mb-14">
                    <i class="fas fa-user-shield"></i>
                    <div>
                        <h2 class="text-xl md:text-2xl mb-1">Selamat Datang, <span id="admin-name-dashboard-banner" class="font-bold text-pmii-yellow">[Nama Admin Komisariat]</span>!</h2>
                        <p>Ini adalah pusat kendali Anda untuk supervisi data kader, manajemen akun pengguna, pengajuan surat, dan administrasi umum lainnya untuk PK PMII UIN Sunan Gunung Djati Cabang Kota Bandung.</p>
                    </div>
                </div>
                
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
                     <a href="manajemen-akun.php" class="dashboard-card group">
                    ...
                    <a href="manajemen-kader.php" class="dashboard-card group">
                        ...
                        <p>Lihat dan kelola data semua kader.</p>
                    </a>
                    <a href="verifikasi-surat.php" class="dashboard-card group">
                         <div class="card-icon-wrapper">
                            <i class="fas fa-file-check card-icon"></i>
                        </div>
                        <h4 class="mb-1">Verifikasi Surat</h4>
                        <p>Proses pengajuan surat dari rayon.</p>
                    </a>
                    <a href="repository-ilmiah.php" class="dashboard-card group">
                         <div class="card-icon-wrapper">
                            <i class="fas fa-book-open card-icon"></i>
                        </div>
                        <h4 class="mb-1">Repository Ilmiah</h4>
                        <p>Kelola unggahan karya ilmiah kader.</p>
                    </a>
                    <a href="pengajuan-surat.php" class="dashboard-card group"> 
                        <div class="card-icon-wrapper">
                            <i class="fas fa-file-import card-icon"></i>
                        </div>
                        <h4 class="mb-1">Riwayat Pengajuan Surat</h4>
                        <p>Lihat riwayat pengajuan surat dari rayon.</p>
                    </a>
                     <a href="../akses-ojs.php" class="dashboard-card group"> 
                        <div class="card-icon-wrapper">
                            <i class="fas fa-link card-icon"></i> 
                        </div>
                        <h4 class="mb-1">Akses OJS</h4>
                        <p>Kelola dan akses Open Journal Systems.</p>
                    </a>
                    <a href="pengaturan-situs.php" class="dashboard-card group"> 
                        <div class="card-icon-wrapper">
                            <i class="fas fa-cogs card-icon"></i> 
                        </div>
                        <h4 class="mb-1">Pengaturan Situs</h4>
                        <p>Konfigurasi umum dan konten website.</p>
                    </a>
                    <a href="dashboard-statistik.php" class="dashboard-card group"> 
                        <div class="card-icon-wrapper">
                            <i class="fas fa-chart-bar card-icon"></i> 
                        </div>
                        <h4 class="mb-1">Dashboard Statistik</h4>
                        <p>Lihat data dan statistik sistem.</p>
                    </a>
                    <a href="kelola-notifikasi.php" class="dashboard-card group"> 
                        <div class="card-icon-wrapper">
                            <i class="fas fa-bell card-icon"></i> 
                        </div>
                        <h4 class="mb-1">Kelola Notifikasi</h4>
                        <p>Kirim dan atur pesan notifikasi.</p>
                    </a>
                    <a href="laporan-analisis.php" class="dashboard-card group"> 
                        <div class="card-icon-wrapper">
                            <i class="fas fa-file-invoice card-icon"></i> 
                        </div>
                        <h4 class="mb-1">Laporan & Analisis</h4>
                        <p>Buat laporan dan analisis data.</p>
                    </a>
                    <a href="edit-beranda.php" class="dashboard-card group"> 
                        <div class="card-icon-wrapper">
                            <i class="fas fa-edit card-icon"></i> 
                        </div>
                        <h4 class="mb-1">Edit Beranda</h4>
                        <p>Kelola konten halaman beranda situs.</p>
                    </a>
                    <a href="../akses-ojs.php" class="dashboard-card group"> 
                        <div class="card-icon-wrapper">
                            <i class="fas fa-book-reader card-icon"></i> 
                        </div>
                        <h4 class="mb-1">Jurnal Al Harokah</h4>
                        <p>Akses dan kelola jurnal ilmiah.</p>
                    </a>
                    <a href="verifikasi-konten-rayon.php" class="dashboard-card group"> 
                        <div class="card-icon-wrapper">
                            <i class="fas fa-check-double card-icon"></i> 
                        </div>
                        <h4 class="mb-1">Verifikasi Konten Rayon</h4>
                        <p>Setujui/Tolak ajuan konten dari rayon.</p>
                    </a>
                    <a href="../generate-qr.php" class="dashboard-card group"> 
                        <div class="card-icon-wrapper">
                            <i class="fas fa-qrcode card-icon"></i> 
                        </div>
                        <h4 class="mb-1">TTD Digital</h4>
                        <p>Kelola tanda tangan digital dan QR.</p>
                    </a>
    ...
    <script type="module" src="../js/admin-dashboard-komisariat.js"></script>
</body>
</html>