<?php
// public/dashboard/rayon-tambah-galeri.php
...
<head>
    ...
    <title>Tambah Galeri Kegiatan - PK PMII UIN Sunan Gunung Djati Cabang Kota Bandung</title>
    ...
    <link rel="stylesheet" href="../css/style.css"> <link rel="stylesheet" href="../css/rayon-tambah-galeri.css"> </head>
<body>
    ...
    <div class="main-content-wrapper">
        <main class="container mx-auto px-4 py-8 lg:py-12">
            ...
            <section id="tambah-galeri-content">
                <div class="text-center mb-10 md:mb-14">
                    <h1 class="text-3xl lg:text-4xl page-title">Ajukan Galeri Kegiatan Baru</h1>
                    <p class="text-md text-text-muted mt-2">Unggah foto-foto kegiatan. Akan diverifikasi oleh Admin Komisariat.</p>
                </div>

                <div class="content-section max-w-2xl mx-auto">
                    <h3 class="text-lg font-semibold mb-6">Detail Galeri</h3>
                    <div id="form-response" class="hidden form-message mb-5"></div>
                    <form id="addGalleryForm" class="space-y-6">
                        <div>
                            <div class="input-group-modern">
                                <input type="text" id="galleryCaption" name="galleryCaption" class="form-input-modern" required placeholder=" ">
                                <label for="galleryCaption" class="form-label-modern">Judul / Keterangan Galeri</label>
                            </div>
                        </div>
                        
                        <div class="space-y-2">
                            <label class="block text-sm font-medium text-text-secondary">Foto Kegiatan (Multiple)</label>
                            <div class="image-upload-area" id="galleryImageUploadArea">
                                <input type="file" id="galleryImageUpload" name="galleryImageUpload" accept="image/png, image/jpeg, image/gif" multiple>
                                <div id="galleryUploadPlaceholder" class="image-upload-placeholder-text">
                                    <i class="fas fa-camera"></i>
                                    <span>Klik atau Seret Foto di Sini</span>
                                    <span class="text-xs text-text-muted">(Pilih beberapa foto, JPG, PNG, GIF)</span>
                                </div>
                            </div>
                            <p class="text-xs text-text-muted mt-1">Anda bisa mengunggah hingga 10 gambar sekaligus. Ukuran file maksimal 2MB per gambar.</p>
                            
                            <div id="gallery-images-preview-list">
                                </div>
                        </div>

                        <button type="submit" class="btn-modern btn-primary-modern w-full">
                            <i class="fas fa-paper-plane mr-2"></i>Ajukan Galeri Kegiatan
                        </button>
                    </form>
                </div>
            </section>
...
<script type="module" src="../js/rayon-tambah-galeri.js"></script>
</body>
</html>