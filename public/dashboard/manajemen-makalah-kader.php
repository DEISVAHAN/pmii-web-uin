<?php
// public/dashboard/manajemen-makalah-kader.php
...
<head>
    ...
    <link rel="stylesheet" href="../css/style.css"> <link rel="stylesheet" href="../css/manajemen-makalah-kader.css"> </head>
<body>
    ...
    <div class="main-content-wrapper">
        <main class="container mx-auto px-4 py-8 lg:py-12">
            ...
            <section id="manajemen-makalah-kader-content">
                ...
                <div id="makalah-form-section" class="content-section mb-8 max-w-2xl mx-auto hidden">
                    ...
                    <form id="makalahForm" class="space-y-6">
                        ...
                        <div class="input-group-modern">
                            ...
                            <label for="makalahPenulis" class="form-label-modern">Nama Penulis Kader</label>
                        </div>
                        ...
                        <div>
                            <label for="file_karya" class="block text-sm font-medium text-text-secondary mb-1">Unggah File Karya (PDF, DOCX, Maks. 10MB)</label>
                            <input type="file" id="file_karya" name="file_karya" class="form-input-modern" accept=".pdf,.doc,.docx">
                ...
                <div class="content-section">
                    <h3 class="text-lg font-semibold mb-4">Daftar Karya Ilmiah</h3>
                    ...
                    <div class="table-modern-wrapper">
                        <table class="table-modern">
                            ...
                            <tbody id="makalahTableBody">
                                <tr><td colspan="7" class="py-8 text-center text-text-muted">Memuat data karya ilmiah...</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
...
<script type="module" src="../js/manajemen-makalah-kader.js"></script>
</body>
</html>