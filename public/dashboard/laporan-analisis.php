<?php
// public/dashboard/laporan-analisis.php
...
<head>
    ...
    <title>Laporan & Analisis - PK PMII UIN Sunan Gunung Djati Cabang Kota Bandung</title>
    ...
    <link rel="stylesheet" href="../css/style.css"> <link rel="stylesheet" href="../css/laporan-analisis.css"> </head>
<body class="antialiased">
    ...
    <div class="main-content-wrapper">
        <main class="container mx-auto px-4 py-8 lg:py-12">
            ...
            <section id="laporan-analisis-content">
                <div class="text-center mb-10 md:mb-14">
                    <h1 class="text-3xl lg:text-4xl page-title">Laporan & Analisis</h1>
                    <p class="text-md text-text-muted mt-2">Buat laporan dan analisis data sistem.</p>
                </div>

                <div class="content-section mb-8">
                    <h3 class="text-lg font-semibold mb-6">Pilih Kriteria Laporan</h3>
                    <div id="report-form-response" class="hidden form-message-container"></div>
                    <form id="reportForm" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <div class="input-group-modern">
                                    <select id="reportType" name="reportType" class="form-input-modern" required>
                                        <option value=""></option>
                                        <option value="kader">Laporan Data Kader</option>
                                        <option value="surat">Laporan Pengajuan Surat</option>
                                        <option value="karya-ilmiah">Laporan Karya Ilmiah</option>
                                        <option value="berita">Laporan Berita & Artikel</option>
                                        <option value="kegiatan">Laporan Kegiatan</option>
                                        <option value="galeri">Laporan Galeri</option>
                                        <option value="aktivitas-sistem">Laporan Aktivitas Sistem</option>
                                    </select>
                                    <label for="reportType" class="form-label-modern">Jenis Laporan</label>
                                </div>
                            </div>
                            <div>
                                <div class="input-group-modern">
                                    <select id="reportPeriod" name="reportPeriod" class="form-input-modern" required>
                                        <option value=""></option>
                                        ...
                                        <option value="last_year">Tahun Lalu</soption>
                                        <option value="custom">Rentang Kustom</option>
                                        <option value="all">Semua Data</option>
                                    </select>
                                    <label for="reportPeriod" class="form-label-modern">Periode Laporan</label>
                                </div>
                            </div>
                        </div>

                        <div id="customPeriodFields" class="grid grid-cols-1 md:grid-cols-2 gap-4 hidden">
                            <div>
                                <div class="input-group-modern">
                                    <input type="date" id="startDate" name="startDate" class="form-input-modern">
                                    <label for="startDate" class="form-label-modern">Tanggal Mulai</label>
                                </div>
                            </div>
                            <div>
                                <div class="input-group-modern">
                                    <input type="date" id="endDate" name="endDate" class="form-input-modern">
                                    <label for="endDate" class="form-label-modern">Tanggal Akhir</label>
                                </div>
                            </div>
                        </div>

                        <div class="flex gap-4">
                            <button type="submit" class="btn-modern btn-primary-modern flex-grow">
                                <i class="fas fa-chart-bar mr-2"></i>Buat Laporan
                            </button>
                            <button type="button" id="exportReportBtn" class="btn-modern btn-outline-modern">
                                <i class="fas fa-file-export mr-2"></i>Ekspor Laporan CSV
                            </button>
                        </div>
                    </form>
                </div>

                <div id="reportResult" class="content-section hidden">
                    <h3 class="text-lg font-semibold mb-6">Hasil Laporan <span id="reportTitleResult" class="text-pmii-blue"></span></h3>
                    <div id="reportContent" class="space-y-4">
                        <p class="text-text-muted">Laporan akan muncul di sini setelah dibuat.</p>
                    </div>
                </div>
            </section>
        </main>
    ...
    <script type="module" src="../js/laporan-analisis.js"></script>
</body>
</html>