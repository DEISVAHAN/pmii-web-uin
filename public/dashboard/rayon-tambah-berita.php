<?php
// public/dashboard/rayon-tambah-berita.php
...
<head>
    ...
    <title>Tambah Berita & Artikel - PK PMII UIN Sunan Gunung Djati Cabang Kota Bandung</title>
    ...
    <link rel="stylesheet" href="../css/style.css"> <link rel="stylesheet" href="../css/rayon-tambah-berita.css"> </head>
<body>
    ...
    <div class="main-content-wrapper">
        <main class="container mx-auto px-4 py-8 lg:py-12">
            ...
            <section id="tambah-berita-artikel-content">
                <div class="text-center mb-10 md:mb-14">
                    <h1 class="text-3xl lg:text-4xl page-title">Ajukan Berita & Artikel Baru</h1>
                    <p class="text-md text-text-muted mt-2">Isi detail berita atau artikel yang ingin Anda ajukan. Akan diverifikasi oleh Admin Komisariat.</p>
                </div>

                <div class="content-section max-w-2xl mx-auto">
                    <h3 class="text-lg font-semibold mb-6">Detail Berita/Artikel</h3>
                    <div id="form-response" class="hidden form-message mb-5"></div>
                    <form id="addNewsArticleForm" class="space-y-6">
                        <div>
                            <div class="input-group-modern">
                                <input type="text" id="newsTitle" name="newsTitle" class="form-input-modern" required placeholder=" ">
                                <label for="newsTitle" class="form-label-modern">Judul Berita/Artikel</label>
                            </div>
                        </div>
                        <div>
                            <div class="input-group-modern">
                                <select id="newsCategory" name="newsCategory" class="form-input-modern" required>
                                    <option value=""></option>
                                    <option value="Berita">Berita Organisasi</option>
                                    <option value="Artikel">Artikel Opini/Ilmiah</option>
                                    <option value="Kegiatan">Liputan Kegiatan</option>
                                    <option value="Pengumuman">Pengumuman Rayon</option>
                                </select>
                                <label for="newsCategory" class="form-label-modern">Kategori</label>
                            </div>
                        </div>
                        
                        <div class="space-y-2">
                            <label class="block text-sm font-medium text-text-secondary">Gambar Utama</label>
                            <div class="image-upload-area" id="imageUploadArea">
                                <input type="file" id="newsImageUpload" name="newsImageUpload" accept="image/png, image/jpeg, image/gif">
                                <img id="newsImagePreview" src="" alt="Pratinjau Gambar" class="image-preview">
                                <div id="newsImageUploadPlaceholder" class="image-upload-placeholder-text">
                            ...
                            <div class="input-group-modern mt-0">
                                <input type="url" id="newsImageUrl" name="newsImageUrl" class="form-input-modern" placeholder=" ">
                                <label for="newsImageUrl" class="form-label-modern">URL Gambar Utama</label>
                            </div>
                        ...
                        <div>
                            <div class="input-group-modern">
                                <textarea id="newsDescription" name="newsDescription" class="form-input-modern" rows="6" required placeholder=" "></textarea>
                                <label for="newsDescription" class="form-label-modern">Isi Berita/Artikel Singkat</label>
                            </div>
                            <p class="text-xs text-text-muted mt-1">Maksimal 300 karakter. Ini akan muncul di kartu berita.</p>
                        </div>
                        <button type="submit" class="btn-modern btn-primary-modern w-full">
                            <i class="fas fa-paper-plane mr-2"></i>Ajukan Berita/Artikel
                        </button>
                    </form>
                </div>
            </section>
...
<script type="module" src="../js/rayon-tambah-berita.js"></script>
</body>
</html>