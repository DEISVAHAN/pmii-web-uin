<?php
// public/digilib-naskah-sejarah.php
...
<head>
    ...
    <title>Perpustakaan Digital - Naskah Sejarah</title>
    <!-- Tailwind CSS -->
    ...
    <link rel="stylesheet" href="css/digilib-naskah-sejarah.css">
</head>
<body>
    ...
    <main class="container mx-auto px-4 py-8 lg:py-12">
        <div id="history-list-view">
            <div class="flex flex-wrap justify-between items-center gap-4 mb-8">
                <div>
                    <h1 class="text-3xl lg:text-4xl page-title">Naskah Sejarah</h1>
                    <p class="text-md text-text-muted mt-2">Arsip dan naskah terkait sejarah pergerakan.</p>
                </div>
            ...
            <p id="no-data-message" class="text-center py-16 text-text-muted hidden">Memuat data naskah sejarah...</p>
        </div>
    </main>
    ...
    <div id="data-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 hidden modal-overlay">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg modal-content transform scale-95">
            <div class="flex justify-between items-center p-5 border-b">
                <h3 id="modal-title" class="text-xl font-bold text-text-primary">Tambah Naskah Sejarah</h3>
            ...
            <form id="data-form" class="p-5 space-y-4">
                ...
                <div>
                    <label for="periode" class="block text-sm font-medium text-gray-700 mb-1">Periode/Tahun</label>
                    <input type="text" id="periode" name="periode" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" placeholder="Contoh: 1960-1970" required>
                </div>
                <div>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">File Naskah</label>
    ...
    <script type="module">
        ...
        import './js/digilib-naskah-sejarah.js';
