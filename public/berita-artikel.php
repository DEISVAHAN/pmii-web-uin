...
// --- Mengambil data Berita & Artikel dari API Backend menggunakan PHP (untuk initial render) ---
$newsArticlesData = [];
try {
    require_once __DIR__ . '/../app/core/Database.php';
    require_once __DIR__ . '/../app/models/NewsArticle.php';
    // Ambil hanya berita/artikel yang disetujui untuk tampilan publik
    $newsArticlesData = \App\Models\NewsArticle::all('approved'); 
} catch (Exception $e) {
    error_log("Error fetching news articles for initial render: " . $e->getMessage());
    $newsArticlesData = []; // Fallback ke array kosong
}

$newsArticlesDataJson = json_encode($newsArticlesData);
...
<head>
    ...
    <title>Berita & Artikel - PK PMII UIN Sunan Gunung Djati Cabang Kota Bandung</title>
    ...
    <link rel="stylesheet" href="css/berita-artikel.css">
</head>
<body>
    ...
    <nav id="navbar" class="text-white py-3.5 navbar-sticky">
        <div class="container mx-auto px-4 lg:px-8 flex justify-between items-center">
            ...
            <div class="hidden lg:flex space-x-6 items-center">
                ...
                <a href="berita-artikel.php" class="nav-link text-sm active-nav-link">Berita</a>
    ...
    <div class="main-content-wrapper">
        <main class="container mx-auto px-4 py-8 lg:py-12">
            ...
            <section id="berita-artikel-page-content">
                <div class="page-header-section">
                    <h1>Berita & Artikel</h1>
                    <p>Temukan informasi terbaru dan artikel menarik dari kami.</p>
                </div>

                <div id="news-list-full" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <!-- News items will be loaded here by JavaScript -->
                    <p class="text-text-muted text-center py-8 col-span-full">Memuat berita dan artikel...</p>
                </div>
                <div id="no-news-message" class="hidden text-text-muted text-center py-8 col-span-full">Tidak ada berita atau artikel yang tersedia saat ini.</div>
            </section>
        </main>
    </div>
    ...
    <script type="module">
        ...
        window.phpNewsArticlesData = <?php echo $newsArticlesDataJson; ?>; // Data berita dari PHP

        // Memuat JavaScript utama untuk halaman ini
        import './js/berita-artikel.js';
    </script>
</body>
</html>
