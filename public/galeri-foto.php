...
// --- Mengambil data Galeri dari API Backend menggunakan PHP (untuk initial render) ---
$galleryItemsData = [];
try {
    require_once __DIR__ . '/../app/core/Database.php';
    require_once __DIR__ . '/../app/models/GalleryItem.php';
    // Ambil hanya item galeri yang disetujui untuk tampilan publik
    $galleryItemsData = \App\Models\GalleryItem::all('approved'); 
} catch (Exception $e) {
    error_log("Error fetching gallery items for initial render: " . $e->getMessage());
    $galleryItemsData = []; // Fallback ke array kosong
}

$galleryItemsDataJson = json_encode($galleryItemsData);
...
<head>
    ...
    <title>Galeri Foto - PK PMII UIN Sunan Gunung Djati Cabang Kota Bandung</title>
    ...
    <link rel="stylesheet" href="css/galeri-foto.css">
</head>
<body>
    ...
    <nav id="navbar" class="text-white py-3.5 navbar-sticky">
        <div class="container mx-auto px-4 lg:px-8 flex justify-between items-center">
            ...
            <div class="hidden lg:flex space-x-6 items-center">
                ...
                <a href="galeri-foto.php" class="nav-link text-sm active-nav-link">Galeri</a>
